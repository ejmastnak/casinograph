...
<template>
  <div class="">
    ...
    <ul class="mt-6 border border-gray-200 rounded-md shadow-sm">
      <li
        v-for="position in positions"
        class="flex px-2 py-1 border-b border-gray-200"
      >
        ...
        <div class="flex items-center ml-auto">
          ...
          <MyLink as="button" method="delete" :href="route('positions.destroy', position.id)" class="ml-1">
