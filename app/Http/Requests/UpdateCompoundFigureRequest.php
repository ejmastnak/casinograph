...
class UpdateCompoundFigureRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'compound_figure_videos.*.description' => ['nullable', 'string', config('constants.validation.max_description_length')],
        ];
    }
